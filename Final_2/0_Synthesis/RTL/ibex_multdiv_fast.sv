...
module ibex_multdiv_fast #(
  ...
  `ASSERT_KNOWN(DivEnKnown, div_en_internal, clk_i, rst_ni)
  `ASSERT_KNOWN(MultEnKnown, mult_en_internal, clk_i, rst_ni)
  `ASSERT_KNOWN(MultDivEnKnown, multdiv_en, clk_i, rst_ni)
  ...
  `ASSERT(IbexMultDivStateValid, md_state_q inside {
      MD_IDLE, MD_ABS_A, MD_ABS_B, MD_COMP, MD_LAST, MD_CHANGE_SIGN, MD_FINISH}, clk_i, rst_ni)
