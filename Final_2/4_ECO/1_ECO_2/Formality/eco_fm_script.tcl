...
set REF_NETLIST       "../../0_ECO_2/output/$top_module\_rt.v"
set IMP_NETLIST   "../output/$top_module\_rt.v"

set SVF "../output/ibex_wrapper_eco_1.svf"
...
# Formality Setup File
set_svf "$SVF/cmd-1.svf"
set_svf -append -ordered "$SVF/cmd-2.svf"
set_svf -append -ordered "$SVF/cmd-3.svf"
