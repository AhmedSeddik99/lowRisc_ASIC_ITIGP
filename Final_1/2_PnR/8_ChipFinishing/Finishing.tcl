...
set PREV_BLOCK "ibex_hvt_routing_change_5"
set BLOCK "ibex_hvt_finishing"


set LOG "./ChipFinishing/log"
sh rm -rf $LOG
sh mkdir -p $LOG

set REPORT "./ChipFinishing/report"
sh rm -rf $REPORT
sh mkdir $REPORT


set OUTPUT "./ChipFinishing/output"
sh rm -rf $OUTPUT
sh mkdir -p $OUTPUT
