...
set BLOCK "ibex_hvt_routing_ss_spef"



set LOG "./LOG/Routing_ss_spef"
sh rm -rf $LOG
sh mkdir -p $LOG


set REPORT "./REPORT/Routing_ss_spef"
sh rm -rf $REPORT
sh mkdir $REPORT


set OUTPUT "./OUTPUT/Routing_ss_spef"
sh rm -rf $OUTPUT
sh mkdir -p $OUTPUT
...
source ibex_wrapper_changes.tcl
...
refine_opt -nets "VDD GND"  > "$LOG/refine_opt.log"
...
write_def "$OUTPUT/ibex_wrapper_ss_spef.def"

write_sdc -output "$OUTPUT/ibex_wrapper_ss_spef.sdc"

write_verilog "$OUTPUT/ibex_wrapper_rt_ss_spef.v"

write_parasitics -output "$OUTPUT/ibex_wrapper_ss_spef"
