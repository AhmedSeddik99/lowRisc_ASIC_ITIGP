...
set LOG "./LOG/Floorplan"
sh rm -rf $LOG
sh mkdir -p $LOG

set OUTPUT "./OUTPUT/Floorplan"
sh rm -rf $OUTPUT
sh mkdir -p $OUTPUT
...
initialize_floorplan -boundary "{0 0} {140 140}" -flip_first_row true -core_offset {18 18 18 18} -control_type core > "$LOG/initialize_floorplan.log"
