...
set REPORT "./REPORT/CTS"
sh rm -rf $REPORT
sh mkdir $REPORT

set OUTPUT "./OUTPUT/CTS"
sh rm -rf $OUTPUT
sh mkdir -p $OUTPUT
...
set TARGET_SKEW 0.100

# 0.3 and 0.2 were set arbitrarily
set_input_transition -rise [expr 0.3*$CLK1_PER] [get_ports clk_i] > "$LOG/set_input_transition.log"
set_input_transition -fall [expr 0.2*$CLK1_PER] [get_ports clk_i] >> "$LOG/set_input_transition.log"
